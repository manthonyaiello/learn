...
.. only:: builder_html
    ...
    *Prove* button. Note also that errors are expected initially -- it is
    up to you to use the output from the prover to correct these and
    produce a working, fully proved stack!
